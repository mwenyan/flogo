...
var inputSchemaDelShare = `{
	 "parameters": {
		 "shareName": "testtci1"
	 }
 }`
var inputSchemaDelShareFail = `{
	"parameters": {
		"shareName": "testtci2"
	}
}`
var inputSchemaDelDir = `{
	"parameters": {
		"shareName": "testtci1",
		"directoryPath": "",
		"directoryName": "a"
...
func Test_delete_share(t *testing.T) {
...
func Test_delete_share_fail(t *testing.T) {
	log.RootLogger().Info("****TEST : Executing InsertOne start****")
	m := make(map[string]interface{})
	err1 := json.Unmarshal([]byte(settingsjson), &m)
	assert.Nil(t, err1)
...
func Test_delete_dir_fail(t *testing.T) {
	log.RootLogger().Info("****TEST : Executing InsertOne start****")
	m := make(map[string]interface{})
	err1 := json.Unmarshal([]byte(settingsjson), &m)
	assert.Nil(t, err1)
...
func Test_delete_file_fail(t *testing.T) {
	log.RootLogger().Info("****TEST : Executing InsertOne start****")
	m := make(map[string]interface{})
	err1 := json.Unmarshal([]byte(settingsjson), &m)
	assert.Nil(t, err1)
