...
@WiContrib({})
@Injectable()
export class ReplaceDocumentActivityContributionHandler extends WiServiceHandlerContribution {
    ...
    value = (fieldName: string, context: IActivityContribution): any | Observable<any> => {
        ...
        switch(fieldName) {
            ...
            case "input":
                let schemaobj = {database: "", collection: "", "x-ms-activity-id": "", "x-ms-documentdb-partitionkey": "", "x-ms-indexing-directive": "", "If-Match":"", id: "" }
                let schema = {
                    ...
                    "required":["database", "collection", "id", "document", "x-ms-documentdb-partitionkey"]
                }
                if(Boolean(doc)){
                    let docschema = JSON.parse(doc);
                    if(Boolean(docschema["$schema"])){
                        schema.properties.document["properties"] = docschema["properties"];
                        return JSON.stringify(schema);
                    } else {
                        schemaobj["document"] = docschema
                ...
                return null;
            case "output":
                let oschemaobj = {code: "", message: "", "x-ms-activity-id": "", "x-ms-session-token":"", id: "" }
