...
@WiContrib({})
@Injectable()
export class CreateDocumentActivityContributionHandler extends WiServiceHandlerContribution {
    ...
    value = (fieldName: string, context: IActivityContribution): any | Observable<any> => {
        ...
        switch(fieldName) {
            ...
            case "input":
                let schemaobj = {database: "", collection: "", "x-ms-activity-id": "", "x-ms-documentdb-partitionkey": "", x_ms_documentdb_is_upsert: true, id: "" }
                let schema = {
