...
@WiContrib({})
@Injectable()
export class GetDocumentActivityContributionHandler extends WiServiceHandlerContribution {
    ...
    value = (fieldName: string, context: IActivityContribution): any | Observable<any> => {
        ...
        switch(fieldName) {
            ...
            case "output":
                let oschemaobj = {code: "", message: "", "x-ms-activity-id": "", "x-ms-session-token":"", "x-ms-continuation": "", "document": {}}
                ...
                if(Boolean(doc)){
                    ...
                    if(Boolean(docschema["$schema"])){
                        ...
                        oschema.properties.document.properties = docschema["properties"]
