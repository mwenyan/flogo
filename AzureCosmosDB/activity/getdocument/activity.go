...
var log = logger.ChildLogger(logger.RootLogger(), "cosmosdb.activity.getdocument")
...
func (a *Activity) Eval(ctx activity.Context) (done bool, err error) {
	...
	token := common.GetAuthToken(cnx.MasterKey, today, "get", "docs", fmt.Sprintf("dbs/%s/colls/%s/docs/%s", db, coll, id))
