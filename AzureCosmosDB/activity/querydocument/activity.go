...
var log = logger.ChildLogger(logger.RootLogger(), "cosmosdb.activity.querydocument")
...
func (a *Activity) Eval(ctx activity.Context) (done bool, err error) {
	...
	if input.Data["parameters"] != nil {
		for k, v := range input.Data["parameters"].(map[string]interface{}) {
			parameters = append(parameters, map[string]interface{}{"name": k, "value": v})
		}
	}
	...
	req.Header.Set("x-ms-documentdb-isquery", strconv.FormatBool(true))
	...
	if input.Data["x-ms-documentdb-query-enablecrosspartition"] != nil {
		req.Header.Set("x-ms-documentdb-query-enablecrosspartition", strconv.FormatBool(input.Data["x-ms-documentdb-query-enablecrosspartition"].(bool)))
	}

	req.Header.Set("Accept", "application/json")
	req.Header.Set("Content-Type", "application/query+json")
	req.Header.Set("x-ms-documentdb-query-enablecrosspartition", strconv.FormatBool(true))
