...
@WiContrib({})
@Injectable()
export class DeleteDocumentActivityContributionHandler extends WiServiceHandlerContribution {
    ...
    value = (fieldName: string, context: IActivityContribution): any | Observable<any> => {
        ...
        switch(fieldName) {
            ...
            case "output":
                let oschemaobj = {code: "", message: "", "x-ms-activity-id": "", "x-ms-session-token":""}
