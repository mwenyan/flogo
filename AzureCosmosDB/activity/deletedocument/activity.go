...
var log = logger.ChildLogger(logger.RootLogger(), "cosmosdb.activity.deletedocument")
...
func (a *Activity) Eval(ctx activity.Context) (done bool, err error) {
	...
	token := common.GetAuthToken(cnx.MasterKey, today, "delete", "docs", fmt.Sprintf("dbs/%s/colls/%s/docs/%s", db, coll, id))
